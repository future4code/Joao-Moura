...
class Post extends React.Component {
  ...
  render() {
    ...
    const caixaDeComentario = this.state.comentando ? (
      ...
      // Função map sendo feita na propriedade comentarios do estado. Ou seja, está sendo pego todos os
    ...
    return <PostContainer>
      <PostHeader>
        <UserPhoto src={this.props.fotoUsuario} alt={'Imagem do usuário'}/>
